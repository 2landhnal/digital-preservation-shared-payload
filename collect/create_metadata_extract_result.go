...
func (client *CollectServicerClient) CreateExtractMetadataResult(ctx context.Context, req *pb.CreateExtractMetadataResultRequest) (*pb.CreateExtractMetadataResultResponse, error) {
