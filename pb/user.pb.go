...
func (x *GetUserResponse) GetIsEmailVerified() bool {
	if x != nil {
...
func (x *GetUserResponse) GetPasswordChangedAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *GetUserResponse) GetAccountType() string {
	if x != nil {
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x02pb\x1a\x1fgoogle/protobuf/timestamp.proto\"&\n" +
	"\x0eGetUserRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\"\xf2\x02\n" +
	"\x0fGetUserResponse\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1f\n" +
	"\bfullname\x18\x02 \x01(\tH\x00R\bfullname\x88\x01\x01\x12(\n" +
	"\x0fisEmailVerified\x18\x03 \x01(\bR\x0fisEmailVerified\x12H\n" +
	"\x11passwordChangedAt\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x11passwordChangedAt\x12\x1a\n" +
	"\broleType\x18\x05 \x01(\tR\broleType\x12 \n" +
	"\vaccountType\x18\x06 \x01(\tR\vaccountType\x128\n" +
	"\tcreatedAt\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12!\n" +
	"\tavatarUrl\x18\b \x01(\tH\x01R\tavatarUrl\x88\x01\x01B\v\n" +
	"\t_fullnameB\f\n" +
	"\n" +
	"_avatarUrlB=Z;github.com/2landhnal/digital-preservation-shared-payload/pbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	2, // 0: pb.GetUserResponse.passwordChangedAt:type_name -> google.protobuf.Timestamp
	2, // 1: pb.GetUserResponse.createdAt:type_name -> google.protobuf.Timestamp
