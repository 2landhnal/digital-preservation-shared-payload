...
const file_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x12auth_service.proto\x12\x02pb\x1a\n" +
	"user.proto2A\n" +
	"\vAuthService\x122\n" +
	"\aGetUser\x12\x12.pb.GetUserRequest\x1a\x13.pb.GetUserResponseB=Z;github.com/2landhnal/digital-preservation-shared-payload/pbb\x06proto3"
...
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: pb.AuthService.GetUser:input_type -> pb.GetUserRequest
	1, // 1: pb.AuthService.GetUser:output_type -> pb.GetUserResponse
