...
const (
	Notifier_SendEmail_FullMethodName = "/pb.Notifier/SendEmail"
)
...
type NotifierClient interface {
	SendEmail(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*SendMailResponse, error)
}
...
func (c *notifierClient) SendEmail(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*SendMailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendMailResponse)
	err := c.cc.Invoke(ctx, Notifier_SendEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotifierServer interface {
	SendEmail(context.Context, *SendMailRequest) (*SendMailResponse, error)
...
func (UnimplementedNotifierServer) SendEmail(context.Context, *SendMailRequest) (*SendMailResponse, error) {
...
func _Notifier_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendMailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotifierServer).SendEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Notifier_SendEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotifierServer).SendEmail(ctx, req.(*SendMailRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Notifier_SendEmail_Handler,
		},
	},
